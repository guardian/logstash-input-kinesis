...
| <<plugins-{type}s-{plugin}-client_version_config_2x_compatibility>> |<<boolean,boolean>>|No
...
[id="plugins-{type}s-{plugin}-client_version_config_2x_compatibility"]
===== `client_version_config_2x_compatibility`
